    ...
    <>
      {isLoading && (
        <div className="fixed inset-0 h-screen w-screen backdrop-blur-sm bg-black/30 flex flex-col justify-center items-center z-50 ">
          <CircularProgress />
        </div> // wartet bis Artikel hochgeladen wird
      )}
      {showVorshau && ( // Vorschsu modus
        <div className="fixed inset-0 h-screen w-screen backdrop-blur-sm bg-black/30 flex flex-col justify-center items-center z-50 ">
          ...
          >
            ...
            <div className="flex gap-4 w-100 justify-end mb-4 mt-6">
              <button
                ...
                type="button"
                className=" shadow p-2 rounded-lg bg-custom-text-green text-white font-medium sm:hover:bg-custom-text-brown "
              >
                Vorschau
              </button>
              <button className=" shadow p-2 rounded-lg bg-custom-text-green text-white font-medium   sm:hover:bg-custom-text-brown ">
                Hochladen
              </button>
            </div>
          </form>
