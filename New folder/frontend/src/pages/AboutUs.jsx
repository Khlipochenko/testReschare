...
export const AboutUs = () => {
  ...
  return (
    <div className="w-9/12 2xl:w-8/12  mx-auto py-36">
      <div className="mt-10">
        <h1 className="text-xl my-4 text-center text-custom-text-brown font-medium">
          Über uns
        </h1>
        <div>
          <p className="mb-6 text-justify">
            Diese Tauschbörse ist das Ergebnis unseres Abschlussprojekts im
            Webentwicklungs-Kurs. Mit viel Leidenschaft und Teamarbeit haben wir
            eine Plattform geschaffen, die nicht nur den Austausch von Artikeln
            ermöglicht, sondern auch unsere erworbenen Fähigkeiten in modernen
            Webtechnologien widerspiegelt. Sie steht für unseren Lernprozess,
            unser Engagement und unsere Zukunft als Entwickler!
          </p>
        </div>
      </div>
            ...
            <div className="flex flex-wrap gap-12 justify-center">
              {team.map((person, i) => (
                <div
                  ...
                  className={
                    i === 3 || i === 4
                      ? "sm:col-span-1 sm:col-start-2 sm:col-end-3"
                      : "sm:col-span-1"
                  }
                >
